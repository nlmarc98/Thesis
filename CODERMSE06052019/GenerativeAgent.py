...
# M: Gen. agent is build once! (inbuilt prob. distr. of giving a cw response for every rod-and-frame orientation).
...
class GenerativeAgent:
    ...
    def __makeProbTable(self):
        ...
        for i in range(self.frame_num):
            ...
            # M: Check prob_tables lenght and sizes.
            # print('size table', self.prob_table.__len__())
            # print('shape table', self.prob_table.shape.__len__())
            # print('shape table size of ', self.prob_table.shape.__sizeof__())
            # print ('table', self.prob_table)
