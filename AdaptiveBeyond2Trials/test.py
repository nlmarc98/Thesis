...
# M: Kappas 25
kappa_ver = np.linspace(sig2kap(2.3), sig2kap(7.4), 7)
# kappa_ver = [sig2kap(4.3)]
kappa_hor = np.linspace(sig2kap(28), sig2kap(76), 7)
...
# for stim_selection in [ 'adaptive', 'adaptive2']:
for stim_selection in ['adaptive2']:
